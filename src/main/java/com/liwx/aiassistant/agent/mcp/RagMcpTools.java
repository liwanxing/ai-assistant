package com.liwx.aiassistant.agent.mcp;
...
public class RagMcpTools {
    ...
    @McpTool(name = "search_knowledge_base",
            description = "搜索 ai_assistant 项目的私有知识库（内部文档库，非公开互联网）。知识库包含该项目相关领域的文档内容，采用向量+关键词混合检索并经过重排序。当用户的问题可能涉及该项目私有资料、内部文档时调用此工具。普通常识问题不要调用。")
